...
- The backup pack contains `routeros.backup`, `routeros.rsc`, firewall, DHCP, DNS, WireGuard, container, and service captures.
...
- Review output names DHCP, DNS, AdGuard, WireGuard, firewall/NAT, service exposure, MacBook lease, and Home Assistant lease state.
